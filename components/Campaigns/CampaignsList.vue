            ...
            >
                <template slot="headers" >
                    ...
                    <tr>
                        ...
                        <th class="column sortable text-xs-left">Tracking<br>Errors</th>
                ...
                <template slot="items" slot-scope="{item}">
                    ...
                    <td>{{ item.leads_count | number}}</td>
                    <td class="bg-red">{{ item.leads_error_count | number}}</td>
                    <td>
    ...
    export default {
        ...
        data () {
            ...
            const headers = [
                ...
                { text: this.$vuetify.t('Untracked'), value: 'leads_error_count' },
